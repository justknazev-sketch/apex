...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Fetch constructor configuration elements and colors
      ...
      try {
        ...
        if (partsRes.ok && colorsRes.ok) {
          ...
          if (colorsData.length > 0) {
            setSelectedColor(colorsData[0]); // default color
          }
        }
      } catch (err) {
  ...
  return (
    <>
              ...
              return (
                <article className="product-card" key={p.id}>
                  ...
                  <div className="product-info">
                    <h3 className="product-name">{getLocalizedName(p)}</h3>
      ...
      <section id="works">
        <div className="section-label">{t('works_label')}</div>
        <h2>{t('works_title')}</h2>
        <p className="section-desc">{t('works_desc')}</p>

        <div className="works-grid">
          <div className="work-card">
            <span className="work-icon-placeholder">🏋️</span>
            <span className="work-card-lbl">{t('works_soon')}</span>
          </div>
          <div className="work-card">
            <span className="work-icon-placeholder">🏗️</span>
            <span className="work-card-lbl">{t('works_soon')}</span>
          ...
          <div className="work-card">
            <span className="work-icon-placeholder">🔩</span>
            <span className="work-card-lbl">{t('works_soon')}</span>
          </div>
          <div className="work-card">
            <span className="work-icon-placeholder">🏗️</span>
